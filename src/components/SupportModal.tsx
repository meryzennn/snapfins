        ...
        <div className="space-y-4">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <span className="block font-bold text-indigo-900 dark:text-indigo-200 text-sm">SocioBuzz</span>
                <span className="block text-[10px] text-indigo-700/60 dark:text-indigo-400/60 font-black uppercase tracking-widest">Support on Local</span>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 bg-white dark:bg-rose-900 rounded-xl flex items-center justify-center shadow-sm">
                <span className="material-symbols-outlined text-rose-500 text-xl">coffee</span>
              </div>
              <div>
                <span className="block font-bold text-rose-900 dark:text-rose-200 text-sm">Ko-fi</span>
                <span className="block text-[10px] text-rose-700/60 dark:text-rose-400/60 font-black uppercase tracking-widest">Buy me a coffee</span>
              </div>
            </div>
            <span className="material-symbols-outlined text-rose-500 opacity-0 group-hover:opacity-100 transition-opacity">arrow_forward</span>
          </a>
        </div>
