...
const GithubStarButton = () => {
  return (
    <a
      href="https://github.com/meryzennn/snapfins"
      target="_blank"
      rel="noopener noreferrer"
      className="group relative dark:bg-neutral-800 bg-neutral-200 rounded-full p-px overflow-hidden inline-block w-full sm:w-[220px] h-[44px]"
    >
      ...
      <span className="flex items-center justify-center gap-1 relative z-[1] dark:bg-neutral-950/90 bg-neutral-50/90 rounded-full h-full px-4 pl-2 w-full">
