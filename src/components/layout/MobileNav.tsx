...
export default function MobileNav() {
  ...
  return (
    <div 
      className="md:hidden fixed bottom-0 left-0 right-0 z-[40] px-4 pb-4 pointer-events-none"
    >
      <div className="bg-surface/80 dark:bg-slate-900/80 backdrop-blur-xl border border-outline-variant/20 rounded-2xl shadow-lg grid grid-cols-3 items-center py-3 pointer-events-auto">
        {navItems.map((item) => {
