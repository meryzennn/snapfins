...
export async function updateSession(request: NextRequest) {
  ...
  // Memproteksi rute Dashboard:
  // Jika user mencoba mengakses halaman dashboard tapi tidak punya session cookie Supabase,
  // maka ia akan dikembalikan secara paksa ke Halaman Utama (/).
