...
export const translations = {
  en: {
    ...
    deleteAccountWarning: 'Are you absolutely sure? This will permanently erase all your transaction history from SnapFins.',
  ...
  id: {
    ...
    btnPrev: 'Sebelumnya',
    btnNext: 'Selanjutnya',
    pageIndicator: (current: number, total: number) => `Halaman ${current} dari ${total}`,
    ...
    deleteAccountWarning: 'Apakah Anda yakin? Ini akan menghapus seluruh riwayat transaksi Anda dari SnapFins secara permanen.',
